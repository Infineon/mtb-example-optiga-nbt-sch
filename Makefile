...
APPNAME=mtb-example-optiga-nbt-sch
...
DEFINES=IFX_T1PRIME_INTERFACE_I2C CY_RETARGET_IO_CONVERT_LF_TO_CRLF MBEDTLS_CONFIG_FILE="<mbedtls-config.h>" \
        IFX_APDU_PROTOCOL_LOG_ENABLE
